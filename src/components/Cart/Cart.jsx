  ...
  return (
    <>
      ...
      <div className="mt-8 relative overflow-x-auto shadow-md sm:rounded-lg">
        <button
          onClick={() => clearItems()}
          className="text-pretty transition-all bg-green-500 p-2 hover:bg-red-600 font-semibold text-white my-5 mx-auto rounded-md cursor-pointer justify-center flex"
        >
          Clear
        </button>
        ...
        <table className="w-3/4 mx-auto my-6 text-sm text-left rtl:text-right text-gray-500">
          <caption className="text-3xl text-green-600 text-center font-semibold my-5  shadow-md p-2">
            Shopping Cart
          </caption>
          ...
          <tbody>
            {cartDetails?.products?.map((product) => (
              <tr
                ...
                className="bg-white border-b transition-all border-gray-200 hover:bg-gray-50 "
              >
                <td className="p-4">
                  <img
      ...
      <Link
        to={"/checkout"}
        className="transition-all bg-green-500 p-2 hover:bg-blue-600 font-semibold text-white  rounded-md cursor-pointer uppercase ms-auto w-fit block mt-10"
      >
        Next Step
      </Link>
    </>
